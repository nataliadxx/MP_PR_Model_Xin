...
for nn=1:10                % for loop controlling running times of the model
    ...
    s(nn,1)=0.9*s1;                 % degree of saturation at t=0, near saturation
    ET=[]; LQ=[];
    %------------------- Climatic condition
...
figure(5)
subplot(4,1,3)
plot((25:0.2:26.8),Eff,'k-')
ylabel ('Efficiency','fontweight','bold','fontsize',10)

subplot(4,1,4)
plot((25:0.2:26.8),xrmvd,'k-')
xlabel ('Temperature (°C)','fontweight','bold','fontsize',10)
